...
import 'package:grocery/modules/User/SearchBar.dart';
      ...
      children: [
        ...
        Expanded(
          child: GridView.builder(
            ...
            itemBuilder: (BuildContext context, int index) => HomeHotItem2(
